...
import BryanResume from "./bryan-funk-resume-promo.webp";
import {CircuitGraphic} from "./circuit";
import ShinyButton from "@/registry/new-york/effects/shine";
...
export default function ResumeSection() {
  return (
    ...
    <CloudDownload
                strokeWidth={2.5}
                className="inset-0 z-[1] m-auto -ml-20 size-96 fill-[var(--gray-a1)] group-hover:motion-scale-in-[0.5] [--motion-translate-duration:8s] [--motion-duration:8s] [--motion-scale-duration:8s]  stroke-[var(--primary-a9)] gradientMask-11 stroke-[0.075px] dark:stroke-[0.05px] mix-blend-hard-light brightness-0 dark:opacity-100 dark:brightness-200"
    />
            </div>
          </a>
        </div>
