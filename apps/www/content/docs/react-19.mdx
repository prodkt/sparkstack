...
When you run `npx sparkstack@latest init -d`, you will be prompted to select an option to resolve the peer dependency issues.
...
If you have any questions, please [open an issue](https://github.com/prodkt/sparkstack/issues) on GitHub.
