const schemas = [
  {
    ...
    fields: [
      ...
      {
        path: "metadata.request.cf.botManagement.corporateProxy",
        type: "boolean",
      },
      {
        path: "metadata.request.cf.botManagement.detectionIds",
        type: "number[]",
      },
      { path: "metadata.request.cf.botManagement.ja3Hash", type: "string" },
      { path: "metadata.request.cf.botManagement.score", type: "number" },
      {
        path: "metadata.request.cf.botManagement.staticResource",
        type: "boolean",
      },
      {
        path: "metadata.request.cf.botManagement.verifiedBot",
        type: "boolean",
      },
      ...
      {
        path: "metadata.request.cf.edgeRequestKeepAliveStatus",
        type: "number",
      },
      ...
      {
        path: "metadata.request.cf.tlsClientAuth.certPresented",
        type: "string",
      },
      { path: "metadata.request.cf.tlsClientAuth.certRevoked", type: "string" },
      {
        path: "metadata.request.cf.tlsClientAuth.certVerified",
        type: "string",
      },
      {
        path: "metadata.request.cf.tlsExportedAuthenticator.clientFinished",
        type: "string",
      },
      {
        path: "metadata.request.cf.tlsExportedAuthenticator.clientHandshake",
        type: "string",
      },
      {
        path: "metadata.request.cf.tlsExportedAuthenticator.serverFinished",
        type: "string",
      },
      {
        path: "metadata.request.cf.tlsExportedAuthenticator.serverHandshake",
        type: "string",
      },
      ...
      {
        path: "metadata.response.headers.x_kong_proxy_latency",
        type: "string",
      },
