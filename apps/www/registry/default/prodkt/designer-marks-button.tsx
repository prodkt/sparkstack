    ...
    <div className="group relative z-[0] hover:z-[1] has-[&_span:focus-visible]:[&_span]:z-[1]">
      ...
      <div className="designer-marks pointer-events-none absolute inset-0 z-[1] h-full w-full select-none">
        <div className="relative m-0 h-full w-full">
          <div className="absolute m-0 size-2 translate-x-[calc(-25%+0px)] translate-y-[calc(-25%+0px)] border bg-background focus-visible:border-primary group-hover:border-primary" />
          ...
          <div className="absolute right-0 m-0 size-2 translate-x-[calc(25%+1px)] translate-y-[calc(-25%+0px)] border bg-background focus-visible:border-primary group-hover:border-primary" />
