...
import type { RippleType } from "@/registry/new-york/hooks/use-ripple"
import { clamp } from "@/registry/new-york/lib/utils"
...
const domAnimation = () =>
  import("@/registry/new-york/lib/dom-animation").then((res) => res.default)
...
export { useRipple } from "@/registry/new-york/hooks/use-ripple"
