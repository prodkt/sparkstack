  ...
  <>
    <div ref={ref} className="absolute inset-0 m-0 size-full" {...props}>
      <div className="relative z-[0] size-full">
        ...
        <div className="absolute -left-1 -top-1 bottom-auto z-[1] mb-auto mt-0 size-2 rounded-none border border-ghost-aa7 bg-ghost-a7" />
        {hideRight ? (
          ""
        ) : (
          <>
            <div className="absolute -right-1 -top-1 bottom-auto z-[1] mb-auto mt-0 size-2 rounded-none border border-ghost-aa7 bg-ghost-a7" />
            <div className="absolute -bottom-1 -right-1 top-auto z-[1] my-0 size-2 rounded-none border border-ghost-aa7 bg-ghost-a7" />
          </>
        )}
        <div className="absolute -bottom-1 -left-1 top-auto z-[1] my-0 size-2 rounded-none border border-ghost-aa7 bg-ghost-a7" />
      </div>
    </div>
    {children}
  </>
