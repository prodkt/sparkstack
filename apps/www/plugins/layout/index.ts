...
export function breakpointUp(name: keyof typeof breakpoints) {
  return `@media (min-width: ${breakpoints[name].width})`
}

export function breakpointDown(name: keyof typeof breakpoints) {
  return `@media (max-width: ${breakpoints[name].width})`
}

export function breakpoint(...args: [keyof typeof breakpoints]) {
...
export function miniUnits(count: number) {
